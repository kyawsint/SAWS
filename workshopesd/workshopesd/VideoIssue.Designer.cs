...
namespace workshopesd {
    ...
    public partial class VideoIssue : global::System.Data.DataSet {
        ...
        public partial class IssueTranDataTable : global::System.Data.TypedTableBase<IssueTranRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public IssueTranRow AddIssueTranRow(string CustomerID, short VideoCode, System.DateTime DateIssue, System.DateTime DateDue, System.DateTime DateActualReturn, string RentalStatus, string Remarks) {
...
namespace workshopesd.VideoIssueTableAdapters {
    ...
    public partial class IssueTranTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[IssueTran] ([CustomerID], [VideoCode], [DateIssue], [DateDue], [DateActualReturn], [RentalStatus], [Remarks]) VALUES (@CustomerID, @VideoCode, @DateIssue, @DateDue, @DateActualReturn, @RentalStatus, @Remarks);
...
SELECT TransactionID, CustomerID, VideoCode, DateIssue, DateDue, DateActualReturn, RentalStatus, Remarks FROM IssueTran WHERE (TransactionID = @TransactionID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TransactionID, CustomerID, VideoCode, DateIssue, DateDue, DateActualReturn" +
                ", RentalStatus, Remarks FROM dbo.IssueTran";
...
SELECT CustomerID, CustomerName, MemberCategory, Address, City, OldPostalCode, PostalCode, CountryCode, ContactTitle, PhoneNumber, Extension, FaxNumber, EmailAddress, Notes FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "select customerid from customers";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT CustomerID, CustomerName FROM dbo.Customers where customerid=@cusid\r\n";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@cusid", global::System.Data.SqlDbType.NVarChar, 4, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByCusDet(VideoIssue.CustomersDataTable dataTable) {
        ...
        public virtual VideoIssue.CustomersDataTable GetDataByCusDet() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            VideoIssue.CustomersDataTable dataTable = new VideoIssue.CustomersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
...
SELECT VideoCode, MovieTitle, MovieType, Rating, RentalPrice, Producer, Director, Media, TotalStock, NumberRented FROM Movies WHERE (VideoCode = @VideoCode)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT VideoCode, MovieTitle FROM dbo.Movies where VideoCode=@vidcod";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
